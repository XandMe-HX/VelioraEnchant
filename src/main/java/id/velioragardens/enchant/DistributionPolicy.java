...
final class DistributionPolicy {
    ...
    FishingRarity cap(Source source) { if(root==null)return FishingRarity.COMMON; try{return FishingRarity.valueOf(root.getString(key(source)+".rarity-cap","COMMON").toUpperCase(Locale.ROOT));}catch(IllegalArgumentException ignored){return FishingRarity.COMMON;} }
