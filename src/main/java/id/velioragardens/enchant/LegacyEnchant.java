...
enum LegacyEnchant {
    ...
    CHUNK(Category.TOOL), COBWEB(Category.WEAPON), CRAVING(Category.WEAPON), CRITICAL(Category.WEAPON), DEATH_ANGEL(Category.ARMOR), DEBUFF(Category.WEAPON), DEFORESTATION(Category.TOOL),
    ...
    LEVELS(Category.TOOL), LIFE_STEAL(Category.WEAPON), LIGHTNING(Category.WEAPON), LIGHT_SPIRIT(Category.ARMOR), LUCK(Category.TOOL), LUCKY_TREASURE(Category.TOOL), MINER_RADAR(Category.TOOL),
    ...
    SUDDEN_BLOW(Category.WEAPON), TANK(Category.ARMOR), TELEPATHY(Category.TOOL), TIME_TRAVEL(Category.ARMOR), UNBREAKING(Category.TOOL), VANISH(Category.ARMOR), VEIN(Category.TOOL),
