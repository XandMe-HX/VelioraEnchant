...
enum FishingRarity {
    ...
    LEGENDARY("legendary", NamedTextColor.GOLD, List.of("sunken_relic", "storm_angler", "mermaid_tears", "deepwater_pact")),
    MYTHIC("mythic", NamedTextColor.RED, List.of("abyssal_hook", "leviathan_line", "relic_seeker")),
    SECRET("secret", NamedTextColor.DARK_PURPLE, List.of("veliora_secret", "secret_whisper"));
